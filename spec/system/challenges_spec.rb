  ...
  describe "作成・編集・削除" do
    ...
    context "管理者の場合" do
      ...
      it "プログラミングテストを作成する" do
        ...
        expect(page).to have_content "テストの標準出力"
      end
      ...
      it "プログラミングテストを編集する" do
        ...
        fill_in "標準出力", with: "編集したテストの標準出力"
        ...
        expect(page).to have_content "編集したテストの標準出力"
      end
